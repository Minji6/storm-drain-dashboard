...
수집한 이미지는 라벨링하고 YOLO data augmentation을 적용해 학습 데이터를 구성했습니다.
...
<table>
  <tr>
    <td width="55%"><img src="docs/yolo_benchmark2.png" width="100%"></td>
    <td width="45%"><img src="docs/yolo_architecture.png" width="100%"></td>
  </tr>
</table>

빗물받이는 도로 환경 사진에서 작고 다양한 형태로 나타나기 때문에 단순 바운딩 박스 탐지보다 **픽셀 단위 세그멘테이션**이 상태 분류에 더 정확합니다. 따라서 YOLOv11-seg를 선택했습니다.

- **정확도**: 동일 추론 속도 대비 이전 버전(v5~v10) 대비 높은 mAP 달성
- **세그멘테이션 지원**: Instance Segmentation으로 빗물받이 영역을 정밀하게 분리해 막힘 정도 판단에 유리
- **경량 아키텍처**: C2PSA·C3K2 모듈로 파라미터 수를 줄이면서 정확도 유지 — 현장 투입 기기에서도 추론 가능

<br>

## AI 분류 — YOLOv11 세그멘테이션

직접 촬영하여 수집한 이미지를 Roboflow로 라벨링해 4개 클래스로 학습했습니다.
...
<img src="docs/yolo_results.jpg" width="680">
...
<table>
  <tr>
    <td width="50%" valign="top"><img src="docs/dashboard_overview2.png" width="100%"></td>
    <td width="50%" valign="top"><img src="docs/dashboard_preview2.png" width="100%"></td>
  </tr>
  <tr>
    <td align="center">종합현황</td>
    <td align="center">지역 상세 관리</td>
  </tr>
</table>
