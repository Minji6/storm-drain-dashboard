...
<table>
  <tr>
    <td width="55%"><img src="docs/yolo_benchmark.png" width="100%"></td>
    <td width="45%"><img src="docs/yolo_architecture.png" width="100%"></td>
  </tr>
</table>

빗물받이는 도로 환경 사진에서 작고 다양한 형태로 나타나기 때문에 단순 바운딩 박스 탐지보다 **픽셀 단위 세그멘테이션**이 상태 분류에 더 정확합니다. YOLOv11-seg를 선택한 이유는 세 가지입니다.
