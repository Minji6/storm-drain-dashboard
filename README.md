...
| 클래스 | 상태 | 예시 |
|--------|------|------|
| `grid_0` | 격자 정상 (완전 개방) | ![정상](docs/sample_grid0.jpg) |
| `grid_1` | 격자 부분 막힘 | ![부분막힘](docs/sample_grid1.jpg) |
| `grid_2` | 격자 완전 막힘 | ![완전막힘](docs/sample_grid2.jpg) |
| `grid_cover` | 덮개로 막혀 있음 | ![덮개](docs/sample_cover.jpg) |
